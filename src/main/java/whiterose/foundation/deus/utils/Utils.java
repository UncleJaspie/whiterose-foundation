...
import whiterose.foundation.deus.modules.GiveSelect;
...
public class Utils {
    ...
    public NBTTagCompound jsonToNbt(String json) {
        ...
        try { base = JsonToNBT.func_150315_a(json);
            ...
            DeusAPI.logger.error(err.getMessage());
        }
    ...
    public void chatMessage(Object chatMessageText) {
        mc().thePlayer.addChatMessage(new ChatComponentText(DeusAPI.format_prefix + nullHelper(chatMessageText)));
    }
