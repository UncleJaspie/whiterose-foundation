...
import whiterose.foundation.deus.render.Images;

public abstract class DeusJFrame extends JFrame implements ActionListener, DeusAPI {
    ...
    private static DeusJFrame lastFrame;
    private boolean resume;
    
    public DeusJFrame(String title, int closeOperation) {
        super(title);
