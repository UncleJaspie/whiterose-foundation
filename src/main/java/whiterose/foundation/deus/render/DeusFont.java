    ...
    public void drawString(String text, int x, int y, int color) {
        ...
        for (char ch : text.toCharArray()) {
            ...
            if (index > -1) {
                ...
                DeusAPI.render.GUI.drawTexturedModalRect(xStart + shadowShift, yStart + shadowShift, pos[0], pos[1], charWidth, fontHeight);
                GL11.glColor4f(rgba[0], rgba[1], rgba[2], rgba[3]);
                DeusAPI.render.GUI.drawTexturedModalRect(x * 2 + sub, y * 2, pos[0], pos[1], charWidth, fontHeight);
                sub += charWidth;
            }
        }
